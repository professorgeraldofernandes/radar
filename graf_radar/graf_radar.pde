...
//               Data: 02/02/2020 
//               C�digo no Processing
//               extens�o do processing .pde                     
/////////////////////////////////////////////////////////////////////////
// Aqui vou apenas explicar os principais comandos do programa a seguir

import processing.serial.*;       // Importa as bibliotecas para comunica��o de Serie
import java.awt.event.KeyEvent;   // Importa as bibliotecas para ler a informa��o da entrada de serie
...
size (1355, 725); // Aqui � onde voc� coloca a resolu��o da sua tela
smooth();

// Aqui tem um detalhe importante:
// onde tem 'Serial.list()[0]', caso d� algum erro
// troque isso pela porta que se Arduino est� tipo "COM3" ok?

Porta_serial = new Serial(this,Serial.list()[0], 9600);   // Come�a a comunica��o Serie
Porta_serial.bufferUntil('.');                             // L� o Serial Monitor at� ao ponto final (lembra do ponto que falamos no c�d do Arduino?
...
fill(98,245,31);        //Aqui voc� coloca a cor (no caso � verde)
textFont(orcFont);
...
// Chama as fun��es Radar, line, Object, Text
...
// Aqui vamos come�ar a ler a serial do Arduino
void serialEvent (Serial Porta_serial) {

//L� a informa��o de Serie at� ao caracter '.', esta informa��o � atribuida a uma string chamada "dados".
...
text("�ngulo: " + iAngulo +" �", width-width*0.48, height-height*0.0277);
